...
BEGIN
    ...
    INSERT INTO wandoor.PROFILE (
        ...
        'P002', 'CIF002', 'ulionp', 'Ulion', 'Pardede', 'Ahnaf',
        TO_DATE('2002-10-12', 'YYYY-MM-DD'),
        '6285784362341', 'ulionp@gmail.com', '3578231210020023',
        'SYSTEM', SYSDATE, SYSDATE, 'SYSTEM'
    );
    ...
    INSERT INTO wandoor.PROFILE (
        ...
        'P001', 'CIF001', 'oktaviaqa', 'Oktavia', 'Qurrota', 'Ayuni',
        TO_DATE('2001-10-29', 'YYYY-MM-DD'),
        '6282139701091', 'oktaviaq.a@gmail.com', '352515000000000',
        'SYSTEM', SYSDATE, SYSDATE, 'SYSTEM'
    );
...
BEGIN
    FOR i IN 1..10 LOOP
        DECLARE
            v_user_id    VARCHAR2(10) := 'P' || LPAD(i, 1, '0');  -- contoh: P003–P010
            v_email      VARCHAR2(200);
            v_password   VARCHAR2(100) := '$2a$05$X/zsEMyrtmc9qob3SmvT2ePYo/wxrZDnLU/ffsobkRfMLdg6C0tVS';
